                ...
                <div class="os-row <?php orchid_store_logo_row_class(); ?>">
                    <div class="os-col logo-col">
                        ...
                        */
						...
						<div id="text-header">
							<p>
								"Пневмотех" - официальный дилер ООО "Арсмаш", <br>производителя компрессоров ЗИФ
							</p>
						</div>
						
						<div id="email-header" class="ref-header">
							<a href="mailto:tozakaz@zif-msk.ru">tozakaz@zif-msk.ru</a>
						</div>
						<div id="phone-header" class="ref-header">
							<a href="tel:8 (499) 123-45-67">8 (499) 123-45-67</a>
						</div>
                    ...
                    if( $orchid_store_display_product_search == true || ( ( $orchid_store_display_minicart == true && class_exists( 'WooCommerce' ) ) || ( $orchid_store_display_wishlist_icon == true && function_exists( 'YITH_WCWL' ) && class_exists( 'WooCommerce' ) ) ) ) {
                        ...
                        <div class="os-col extra-col">
                            <div class="aside-right">
								...
								<a class="orange-button button-header popmake-590" href="#">Быстрый заказ</a>
								
								<a class="transparent-button button-header popmake-667	" href="#">Обратный звонок</a>
