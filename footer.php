...
?>
	...
	<footer class="footer secondary-widget-area">
        <div class="footer-inner">
			...
			<div class="footer-mask border-oran">
				<div class="__os-container__">
                    <div class="footer-entry">
                            ...
                            <div class="os-row">
                                <div class="os-col copyrights-col">
    		                        ...
    		                        */
                                    ...
                                    ?>
									<p>
										119435, г. Москва, м. Спортивная, ул Малая Пироговская 18, стр 1
									</p>
                                </div><!-- .os-col -->
                                <div class="os-col">
                                    <?php
...
<script>
  ...
  jQuery( "#closed-cat" ).slideToggle( "fast" );
		jQuery( "#open-cat" ).hide( "fast" );
});
jQuery( "#close-cat" ).click(function() {
  jQuery( "#closed-cat" ).slideToggle( "fast" );
	jQuery( "#open-cat" ).show( "fast" );
});
	
	jQuery( "#open-filter" ).click(function() {
  jQuery( ".filter-block" ).slideToggle( "fast" );
