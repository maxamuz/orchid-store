...
if( get_theme_mod( 'orchid_store_field_enable_home_content', true ) == true && is_front_page() && ! is_home() ) {
    ...
    <div class="inner-page-wrap default-page-wrap default-page-s1">
		<img src="/wp-content/uploads/2021/10/Group-41.png" class="fon" id="fon-page">
		<div id="desktop-slider" class="slider">
			<?php echo do_shortcode('[smartslider3 slider="2"]'); ?>
		</div>
		
		<div id="desktop-pad" class="slider">
		<?php
echo do_shortcode('[smartslider3 slider="3"]');
?>
		</div>
		<div id="desktop-mobile" class="slider">
		<?php
...
?>
    	...
    	*/
        ...
        <div class="__os-container__">
            <div class="os-row">
                <div class="col-desktop-12 content-col col-tab-100 col-mob-100">
